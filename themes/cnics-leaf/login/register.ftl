    ...
    <#elseif section = "form">
        <form id="kc-register-form" class="${properties.kcFormClass!}" action="${url.registrationAction}" method="post">
            ...
            <div class="form-group">
                <div class="${properties.kcLabelWrapperClass!}">
                    <label for="user.attributes.organization" class="${properties.kcLabelClass!}">
                      Organization</label>
                </div>

                <div class="${properties.kcInputWrapperClass!}">
                    <input type="text" class="${properties.kcInputClass!}"
                      id="user.attributes.organization" name="user.attributes.organization"
            ...
            <h6>Details are collected for the purpose of understanding who the uesrs are and supporting password reset/access.  Data are stored securely and not shared outside of HIV SUCCESS.</h6>
            </div>
        </form>
    </#if>
