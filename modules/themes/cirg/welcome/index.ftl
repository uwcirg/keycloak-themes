...
<head>
	...
	<title>${properties.productName!'CIRG'}</title>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4">
                            <div class="card">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <p class="card-text">
	                                            Access the Administration Console to manage, configure, and monitor your authentication server.
                                            </p>
                                            <a class="btn btn-primary" href="${adminUrl}">Enter Administration Console</a>
                                    </div>
                            </div>
                    </div>
                </#if>
		...
		<div class="col-xs-12 col-sm-6 col-md-4">
			<div class="card">
                                ...
                                <div class="card-body">
                                        ...
                                        <p class="card-text">
	                                        For detailed guidance on using the server, be sure to check our documentation, which includes the User Guide, Admin REST API, and Javadocs.
                                        </p>
                                        <a class="btn btn-primary" href="${properties.documentationUrl}">View Documentation</a>
                                </div>
			</div>
		</div>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4">
                                <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">
	                                            If you're experiencing any issues with the authentication process or have found a bug, please reach out to our administration team for support.
                                            </p>
                                            <a class="btn btn-primary" href="mailto:${properties.contactEmail}">Report an Issue</a>
                                        </div>
                                </div>
                        </div>
                </#if>
